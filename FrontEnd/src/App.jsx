...
function App() {
  ...
  const addMovie = async (movieData) => {
    try {
      ...
      setToast({ message: 'Failed to add movie', type: 'red' });
      return null;
    }
  };
  ...
  const toggleWatched = async (id, watched) => {
    try {
      ...
      console.error('Toggle watched failed', err);
      setToast({ message: 'Failed to update movie', type: 'red' });
      return null;
    }
  };
  ...
  const deleteMovie = async (id) => {
    try {
      ...
      setToast({ message: 'Failed to delete movie', type: 'red' });
      return false;
    }
  };
